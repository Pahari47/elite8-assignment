...
export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-blue-900 to-gray-800 px-4">
      ...
      <span className="inline-block bg-blue-600 text-white font-semibold px-8 py-3 rounded-full shadow-lg text-lg opacity-80 cursor-not-allowed select-none">Get Started: Use Login Button Above</span>
    </div>
  );
} 